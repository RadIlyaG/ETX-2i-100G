...
if 1 {
  ...
  set s1 [file normalize //prod-svm1/tds/AT-Testers/JER_AT/ilya/TCL/ETX-2-100G/AT-ETX-2-100G]
  set d1 [file normalize  C:/AT-ETX-2-100G]
  ...
  set ret [RLAutoSync::AutoSync "$s1 $d1" -noCheckFiles {init*.tcl skipped.txt *.db} \
      -jarLocation C:/RadApps -javaLocation $gaSet(javaLocation) -emailL $emailL -putsCmd 1 -radNet $gaSet(radNet)]
  #console show
  puts "ret:<$ret>"
  set gsm $gMessage
